	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session == null) {
			...
			try {
				...
				p1s.createAccount(user, new Account(10000, user.getUserName(), amount, false));
				returnMessage = "New account created successfully. Redirecting...";
				pw.write(returnMessage);
			} catch (NumberFormatException e) {
				returnMessage = "Invalid balance entered";
				pw.write(returnMessage);
